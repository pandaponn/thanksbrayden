...
<div class="container">
	...
	<?php if ($isLoggedIn == true) : ?>
		...
		<?php
			$userInfoLinkedIn = $adapters['LinkedIn']->getUserProfile();
			print "<p><strong>id:</strong> " . $userInfoLinkedIn->identifier . "</p>";
			...
			print "<p><strong>fname:</strong> " . $userInfoLinkedIn->firstName . "</p>";
			print "<p><strong>lname:</strong> " . $userInfoLinkedIn->lastName . "</p>";
